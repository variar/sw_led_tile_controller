...
#define LED_BUFFER_PARTS 1
#define LED_BUFFER_HEIGHT (LED_BUFFER_PARTS * FRAME_HEIGHT)

// Gives us FRAME_HEIGHT and FRAME_WIDTH
#define LED_BUFFER_ROW_SIZE (FRAME_WIDTH*LED_BUFFER_COLORS)
#define LED_BUFFER_FRAME_SIZE     (LED_BUFFER_COLORS*LED_BUFFER_HEIGHT * FRAME_WIDTH)
